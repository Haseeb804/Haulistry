...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void _saveProfile() async {
    ...
    try {
      // Format date of birth if selected
      String? dateOfBirth;
      if (_selectedDate != null) {
        dateOfBirth = _selectedDate!.toIso8601String().split('T')[0]; // YYYY-MM-DD
      }

      // Update seeker profile with all fields
      final success = await authService.updateSeekerProfile(
        ...
        profileImage: _profileImagePath, // Will be null if not set
